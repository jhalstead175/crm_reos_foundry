...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Top Navigation Bar - Vercel/GitHub Style */}
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-8">
              <Link to="/" className="flex items-center gap-2 hover:opacity-75 transition-opacity">
                ...
                <span className="text-sm font-semibold text-gray-900">REOS CRM</span>
              </Link>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="ml-1 w-7 h-7 bg-black rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transition-opacity">
