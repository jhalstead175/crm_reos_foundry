            ...
            <div className="bg-surface-panel rounded-lg border border-surface-subtle p-6">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button className="px-4 py-2 bg-surface-panel border border-surface-subtle rounded-md hover:border-accent-primary text-subheadline-emphasized motion-button">
                    Link to Contact
                  </button>
                </div>
              </div>
